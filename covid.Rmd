...
covid_datos <- read.csv("Datasets/covid_datos.txt", sep=";")
...
top_3 <- covid_datos[covid_datos$Territorio != "spain" & covid_datos$Territorio != "Andalucia" & covid_datos$Medida == "confirmados"] %>%
  top_n()
```